...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('../../web/pens.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form class="login100-form validate-form p-b-33 p-t-5" action="" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text" name="nomor" placeholder="NRP/NIP">
					...
					<div class="container-login100-form-btn m-t-32 daftar">
