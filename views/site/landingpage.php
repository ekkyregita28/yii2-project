...
<head>
    ...
    <!-- educate icon CSS
		============================================ -->
    <link rel="stylesheet" href="../../web/css/educate-custon-icon.css">
    <!-- morrisjs CSS
		============================================ -->
    <link rel="stylesheet" href="../../web/css/morrisjs/morris.css">
    <!-- mCustomScrollbar CSS
		============================================ -->
    <link rel="stylesheet" href="../../web/css/scrollbar/jquery.mCustomScrollbar.min.css">
    <!-- metisMenu CSS
		============================================ -->
    <link rel="stylesheet" href="../../web/css/metisMenu/metisMenu.min.css">
    <link rel="stylesheet" href="../../web/css/metisMenu/metisMenu-vertical.css">
    <!-- calendar CSS
		============================================ -->
    <link rel="stylesheet" href="../../web/css/calendar/fullcalendar.min.css">
    <link rel="stylesheet" href="../../web/css/calendar/fullcalendar.print.min.css">
    <!-- style CSS
		============================================ -->
...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="../../web/img/logo/logo.png" alt="" /></a>
                <strong><a href="index.html"><img src="../../web/img/logo/logosn.png" alt="" /></a></strong>
            </div>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                    ...
                                                    <div role="menu" class="author-message-top dropdown-menu animated zoomIn">
                                                        ...
                                                        <ul class="message-menu">
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="../../web/img/contact/1.jpg" alt="">
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="../../web/img/contact/4.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Sulaiman din</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="../../web/img/contact/2.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															<img src="../../web/img/product/pro4.jpg" alt="" />
                                                                        ...
                                                                        <ul class="notes-menu-list">
                                                                            ...
                                                                            <li>
                                                                                <a href="#">
                                                                                    <div class="notes-list-flow">
                                                                                        <div class="notes-img">
                                                                                            <img src="../../web/img/contact/3.jpg" alt="" />
                                                                                        </div>
                                                                                        <div class="notes-content">
                                                                                            <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                            <span>Yesterday 2:45 pm</span>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="single-cards-item">
                            <div class="single-product-image">
                                <a href="#"><img src="../../web/img/product/profile-bg.jpg" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="single-review-st-item res-mg-t-30 table-mg-t-pro-n">
                            ...
                            <div class="single-review-st-text">
                                <img src="../../web/img/notification/1.jpg" alt="">
                            ...
                            <div class="single-review-st-text">
                                <img src="../../web/img/notification/2.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Garbease sha</h3>
                                    <p>Awesome Pro</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="../../web/img/notification/3.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Gobetro pro</h3>
                                    <p>Great Website</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="../../web/img/notification/4.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Siam Graves</h3>
                                    <p>That's Good</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="../../web/img/notification/5.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Sarah Graves</h3>
                                    <p>Highly recommend</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="../../web/img/notification/6.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Julsha Grav</h3>
                                    <p>Sei Hoise bro</p>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="single-product-item res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="single-product-image">
                                <a href="#"><img src="../../web/img/product/book-4.jpg" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="courses-inner res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="courses-title">
                                <a href="#"><img src="../../web/img/courses/1.jpg" alt="" /></a>
    ...
    <!-- price-slider JS
		============================================ -->
    <script src="../../web/js/jquery-price-slider.js"></script>
    <!-- meanmenu JS
		============================================ -->
    ...
    <!-- counterup JS
		============================================ -->
    <script src="../../web/js/counterup/jquery.counterup.min.js"></script>
    <script src="../../web/js/counterup/waypoints.min.js"></script>
    <script src="../../web/js/counterup/counterup-active.js"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    <script src="../../web/js/scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="../../web/js/scrollbar/mCustomScrollbar-active.js"></script>
    <!-- metisMenu JS
		============================================ -->
    <script src="../../web/js/metisMenu/metisMenu.min.js"></script>
    <script src="../../web/js/metisMenu/metisMenu-active.js"></script>
    <!-- morrisjs JS
		============================================ -->
    <script src="../../web/js/morrisjs/raphael-min.js"></script>
    <script src="../../web/js/morrisjs/morris.js"></script>
    <script src="../../web/js/morrisjs/morris-active.js"></script>
    <!-- morrisjs JS
		============================================ -->
    <script src="../../web/js/sparkline/jquery.sparkline.min.js"></script>
    <script src="../../web/js/sparkline/jquery.charts-sparkline.js"></script>
    <script src="../../web/js/sparkline/sparkline-active.js"></script>
    <!-- calendar JS
		============================================ -->
    <script src="../../web/js/calendar/moment.min.js"></script>
    <script src="../../web/js/calendar/fullcalendar.min.js"></script>
    <script src="../../web/js/calendar/fullcalendar-active.js"></script>
    <!-- plugins JS
		============================================ -->
    ...
    <!-- tawk chat JS
		============================================ -->
    <script src="../../web/js/tawk-chat.js"></script>
</body>
